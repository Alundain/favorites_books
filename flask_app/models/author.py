...
class Author:
    ...
    def get_all(cls):
        ...
        authors =[]
        for au in results:
            authors.append(cls(au))
        return authors
    
    @classmethod
    def save (cls, data):
        query = "INSERT INTO authors (name) VALUES (%(name)s);"
        result = connectToMySQL('favorites_books').query_db(query,data)
        return result
    
    
    @classmethod
    def unfavorites_authors(cls,data):
    ...
    def get_by_id(cls,data):
        ...
        for row in results:
            ...
            libro=book.Book(data)
            print(libro)
            author.libros_favoritos.append(libro)
        return author